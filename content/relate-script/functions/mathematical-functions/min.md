...
---
The min(...) function has only one variation, not counting syntax variations. It finds the minimum number in a list of numbers ignoring null values. This function will only return null if all input values are null. The result is an Integer value if all inputs are Integer values, otherwise the result is a Float value.

**Syntax:**
**min(** *list-of-numbers* **)**
*first-number***.min(** *list-of-numbers* **)**

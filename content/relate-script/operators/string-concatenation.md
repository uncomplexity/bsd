...
When you do this, the number 4 is first converted to a String, "4", then concatenated to the original String. You can put the thing to be concatenated either before or after the String. For instance,
 3.1415 + " is the value of pi"String concatenation is one of the few operations which does not result in null if one of the input values is null. The only way to get a null result is if both inputs are null. If only one input is null, the result is the other, non-null input. [https://bluestepplatformsupport.bluestep.net/shared/custompage/custompage.jsp?_event=view&_id=445506___3155](https://bluestepplatformsupport.bluestep.net/shared/custompage/custompage.jsp?_event=view&_id=445506___3155) [https://bluestepplatformsupport.bluestep.net/shared/custompage/custompage.jsp?_event=view&_id=445506___3160](https://bluestepplatformsupport.bluestep.net/shared/custompage/custompage.jsp?_event=view&_id=445506___3160)

...
---
The setNotes(...) function has only one variation, not counting syntax variations. The function simply changes the notes stored with the currently referenced document. The result of the setNotes(...) function is a boolean value indicating if the procedure was successful.**Syntax:**
**setNotes(** *document-field***,** *notes* **)**
